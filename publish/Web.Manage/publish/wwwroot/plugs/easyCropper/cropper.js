...
layui.define(['jquery'], function (exports) {
    ...
    var render = {
        ...
        renderCropBox: function renderCropBox() {
            ...
            //cropBox.width = options.minCropBoxWidth;// Math.min(Math.max(cropBox.width, cropBox.minWidth), cropBox.maxWidth);
            //cropBox.height = options.minCropBoxHeight;// Math.min(Math.max(cropBox.height, cropBox.minHeight), cropBox.maxHeight);
