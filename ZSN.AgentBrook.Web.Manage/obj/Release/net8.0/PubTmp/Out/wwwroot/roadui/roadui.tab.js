...
;RoadUI.Tab = function (options)
{
    ...
    this.init = function ()
    {
        ...
        var $tabTitleBox = $('<div class="tab_title_box"></div>');
        ...
        var $tabTitleRight_user_box = $('<div class="tab_title_right_user_box"></div>');
        var $users_img = $('<div class="users-img"><img src="' + defaults.headImg + '" width="38" height="38" ><i class="mes">' + defaults.infoNum + '</i><span>' + defaults.userName + '</span></div>');
        var $user_menu = $('<ul class="ul-dropdown-menu">' + defaults.ulHtml + '</ul>');
        
        $user_menu.hide();
        
        $users_img.bind("click", function ()
        {
            if(!defaults.user_menu_show){
                $('.ul-dropdown-menu').show(500);
                defaults.user_menu_show = true;
            }else{
                $('.ul-dropdown-menu').hide(500);
                defaults.user_menu_show = false;
            }
        });
        
        $tabTitleRight_user_box.append($users_img,$user_menu);
        ...
        {
            //$tabTitleBox.append($tabTitle,$tabTitleRight_user_box);
            this.$tabDiv.append($tabTitle,$tabTitleRight_user_box);
        }
    ...
    {
        var tabWidth = (parseInt(this.$tabDiv.width()) || 130) - 130;
        var ulWidth = 20;
    ...
    this.moveLeft = function ()
    {
        ...
        if (ulWidth - Math.abs(tabLeft) < (parseInt($tabTitle.width()) || 130))
        {
            return;
        }
