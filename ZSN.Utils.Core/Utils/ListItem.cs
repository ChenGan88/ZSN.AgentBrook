...
{
    //[ControlBuilder(typeof(ListItemControlBuilder)), TypeConverter(typeof(ExpandableObjectConverter)), ParseChildren(true, "Text")]
    public sealed class ListItem // : IStateManager, IParserAccessor, IAttributeAccessor
    {
        ...
        //        {
        //            object[] objArray1 = new object[] { "ListItem" };
        //            throw new HttpException(SR.GetString("Control_Cannot_Databind", objArray1));
        //        }
        //        object[] args = new object[] { "ListItem", obj.GetType().Name.ToString(CultureInfo.InvariantCulture) };
        //        throw new HttpException(SR.GetString("Cannot_Have_Children_Of_Type", args));
        //    }
        //}
